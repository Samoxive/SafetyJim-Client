...
export const commands: Command[] = [
    {
        ...
        usages: [
            '-mod ban @user', '-mod ban @user <reason>',
            '-mod ban @user <reason> | <time>',
            '-mod ban <username> <reason> | <time>',
            '-mod ban <user_id> <reason> | <time>'
        ],
        examples: [
            '-mod ban @Samoxive#1234', '-mod ban @Samoxive#1234 Spamming',
            '-mod ban @Samoxive#1234 Messaging invite links | 1 day',
            '-mod ban Samox | 3 days', '-mod ban 145456746721312768'
        ]
    },
    {
        name: 'Hardban',
        ...
        usages: [
            '-mod hardban @user', '-mod hardban @user <reason>',
            '-mod hardban <username> <reason>',
            '-mod hardban <user_id> <reason>'
        ],
        examples: [
            '-mod hardban @Samoxive#1234',
            '-mod hardban @Samoxive#1234 Spamming', '-mod hardban Samox',
    ...
    },
    {
        ...
        usages: [
            '-mod kick @user', '-mod kick @user <reason>',
            '-mod kick <username> <reason>', '-mod kick <user_id> <reason>'
        ],
        examples: [
    ...
    },
    {
        ...
        usages: [
            '-mod mute @user', '-mod mute @user <reason>',
            '-mod mute @user <reason> | <time>',
            '-mod mute <username> <reason> | <time>',
            '-mod mute <user_id> <reason> | <time>'
        ],
        examples: [
            '-mod mute @Samoxive#1234', '-mod mute @Samoxive#1234 Spamming',
    ...
    },
    {
        ...
        usages: [
            '-mod warn @user', '-mod warn @user <reason>',
            '-mod warn <username> <reason>', '-mod warn <user_id> <reason>'
        ],
        examples: [
    ...
    },
    {
        ...
        usages: [
            '-mod softban @user', '-mod softban @user <reason>',
    ...
    },
    {
        ...
        usages: [
            '-mod settings display', '-mod settings list',
            '-mod settings set <setting key> <value>', '-mod settings reset'
        ],
        examples: [
            '-mod settings display', '-mod settings list',
            '-mod settings set Prefix -jim', '-mod settings reset'
        ]
    },
    {
        name: 'Server',
    ...
    },
    {
        ...
        usages: [
            '-mod clean <number>', '-mod clean <number> bot',
            '-mod clean <number> @user', '-mod clean <number> <username>',
            '-mod clean <number> <user_id>'
        ],
        examples: [
            '-mod clean 5', '-mod clean 2 bot', '-mod clean 10 @Samoxive#1234',
            '-mod clean 50 Samoxi', '-mod tag 3 145456746721312768'
        ]
    },
    {
        name: 'Remind',
    ...
    },
    {
        ...
        usages: [
            '-mod unban @user', '-mod unban <username>', '-mod unban <user_id>'
        ],
        examples: [
            '-mod unban @Samoxive#1234', '-mod unban samox',
    ...
    },
    {
        ...
        usages: [
            '-mod unmute @user', '-mod unmute <username>',
            '-mod unmute <user_id>'
        ],
        examples: [
            '-mod unmute @Samoxive#1234', '-mod unmute melo',
    ...
    },
    {
        ...
        usages: [
            '-mod tag list', '-mod tag <name>', '-mod add <name> <response>',
            '-mod edit <name> <response>', '-mod remove <name>'
        ],
        examples: [
            '-mod tag list', '-mod tag rule1',
