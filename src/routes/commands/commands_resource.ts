...
export const commands: Command[] = [
    ...
    },
    {
        ...
        usages: ['-mod kick @user', '-mod kick @user <reason>'],
        examples: [
    ...
    },
    {
        ...
        description:
            'Softbans the mentioned user, banning and unbanning them afterwards. This deletes ' +
    ...
    },
    {
        ...
        usages: ['-mod role add <roleName>', '-mod role remove <roleName>'],
    ...
    },
    {
        ...
        description:
            'Unbans the specified user, due to limitiations of discord, ' +
            'a name and discriminator is needed instead of a user mention.',
        usages: [
            '-mod unban user#discriminator',
        ],
        examples: ['-mod unban Samoxive#1234']
    },
    {
        name: 'Unmute',
        ...
        usages: ['-mod unmute @user'],
        examples: ['-mod unmute @Samoxive#1234']
    },
    {
        name: 'Tag',
