...
const ToS: React.FC<{}> = () => (
    <div style={{ maxWidth: "600px", marginLeft: "auto", marginRight: "auto" }}>
        ...
        <p>
            ...
            Agreement or legal relationship with the Owner in a legally binding
            way. Capitalized words are defined in the relevant dedicated section
            of this document. The User must read this document carefully.
        </p>
        <p>
            This Website is provided by Discord user Samoxive#8634
            (145456746721312768),{" "}
            <strong>Owner contact email: samil.nart |at| gmail.com</strong>
        </p>
        <p>
            "This Website" refers to this website, including its subdomains and
            any other website through which the Owner makes its Service
            available; the Application Program Interfaces (API) and the Service.
        </p>
        <h2>TERMS OF USE</h2>
        <p>
            ...
            document. By using this Website, Users confirm to meet the following
            requirements:
        </p>
        <h3>Account registration</h3>
        <p>
            To use the Service Users may authenticate through Discord. By
            logging in, Users agree to be fully responsible for all activities
            that occur under their authenticated Discord account. Users are
            required to immediately and unambiguously inform the Owner via the
            contact details indicated in this document, if they think their
            access credentials have been violated, unduly disclosed or stolen.
        </p>
        <h3>Account termination</h3>
        <p>
            Users can terminate their account and stop using the Service at any
            time by doing the following: By directly contacting the Owner at the
        ...
        <p>
            ...
            inappropriate, offensive or in violation of these Terms. The
        ...
        <p>
            This Website and the Service may only be used within the scope of
        ...
        <p>
            ...
            Website and/or the Service violates no applicable law, regulations
        ...
        <p>
            ...
            Users access to this Website or the Service, terminating contracts,
            reporting any misconduct performed through this Website or the
            ...
            to engage in any of the following activities: violate laws,
            regulations and/or these Terms; infringe any third-party rights;
            considerably impair the Owner’s legitimate interests; offend the
        ...
        <p>
            ...
            or related to this Website are held by the Owner and/or its
            licensors.
        </p>
        <p>
            ...
            the software and/or any other technical means embedded in the
            Service within the scope and for the purposes of this Website and
            the Service offered.
        </p>
        <p>
            This license does not grant Users any rights to access, usage or
            disclosure of the original source code. All techniques, algorithms,
            and procedures contained in the software and any documentation
            thereto related is the Owner’s or its licensors’ sole property.
        </p>
        <p>
            All rights and license grants to Users shall immediately terminate
        ...
        <p>
            ...
            this Website, is bound by these Terms and, in addition, by the
            following specific terms: the User expressly understands and agrees
            that the Owner bears no responsibility and shall not be held liable
            for any damages or losses resulting from the User’s use of the API
